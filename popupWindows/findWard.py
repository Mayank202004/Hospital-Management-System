...
class findWard(tk.Tk):
    ...
    def create_widgets(self):
        ...
        self.searchbycbox=bs.Combobox(frametop,values=['Ward Name','Ward Type'])
        ...
        self.table = ttk.Treeview(tableframe, column=('WardID','WardName','WardType'), xscrollcommand=s.set, yscrollcommand=s2.set)
        ...
        self.table.heading('WardID', text='Ward ID')
        self.table.heading('WardName', text='Ward Name')
        self.table.heading('WardType', text='Ward Type')

        self.table['show'] = 'headings'

        self.table.column('WardID', width=20)
        self.table.column('WardName', width=134)
        self.table.column('WardType', width=134)
    ...
    def fetch_details(self):
        ...
        if(searchby=="Ward Name"):
            searchby="WardName"
        elif(searchby=="Ward Type"):
            searchby="WardType"
        value = self.searchby_text.get("1.0", "end-1c")
        data = self.db.search_wards(searchby,value)
        for dept in data:
    ...
    def on_select(self, event=None):
        ...
        if selection:
            ...
            self.parent_window.setward(id,name)
